      ...
      ((e = n.nmd(e)),
        (s = function () {
          ...
          function ep(e, n) {
            return function (s) {
              return null != s
                ? (ek(this, e, s), t.updateOffset(this, n), this)
                : ev(this, e);
            };
          }
          function ev(e, t) {
          ...
          function eL() {
            ...
            (a.sort(e),
              ...
              (this._weekdaysStrictRegex = RegExp(
                "^(" + u.join("|") + ")",
                "i",
              )),
            ...
            if (!e._d) {
              for (
                d = new Date(t.now()),
                  ...
                  null != e._dayOfYear &&
                    ((g = te(e._a[0], _[0])),
                    (e._dayOfYear > eg(g) || 0 === e._dayOfYear) &&
                ...
                e._a[f] = w[f] = _[f];
              for (; f < 7; f++)
                e._a[f] = w[f] = null == e._a[f] ? (2 === f ? 1 : 0) : e._a[f];
              (24 === e._a[3] &&
                0 === e._a[4] &&
                0 === e._a[5] &&
                0 === e._a[6] &&
          ...
          function tu(e, t) {
            var s, i;
            if ((1 === t.length && n(t[0]) && (t = t[0]), !t.length))
              return tr();
          ...
          function ty(e, n) {
            ...
            return n._isUTC
              ? ((s = n.clone()),
                (i =
                  (k(e) || u(e) ? e.valueOf() : tr(e).valueOf()) - s.valueOf()),
          ...
          ((tj.add = tO),
            (tj.calendar = function (e, a) {
              ...
              return this.format(
                _ || this.localeData().calendar(m, this, tr(c)),
              );
            }),
            (tj.clone = function () {
              return new v(this);
            ...
            (tj.endOf = function (e) {
              ...
              switch (((s = this._isUTC ? tC : tR), e)) {
                ...
                case "quarter":
                  n =
                    s(this.year(), this.month() - (this.month() % 3) + 3, 1) -
                    1;
                  break;
                case "month":
